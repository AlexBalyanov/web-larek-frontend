...
родительским контейнером. Основной метод класса: 
...
### Слой данных
Классы отвечают за хранение и работу с данными веб приложения.\
Интерфейсы для таких классов описаны в файле `types.ts`.
#### Класс ProductsData
...
DOM элемента - контейнера. Интерфейсы для таких классов описаны в файле `types.ts`.

#### Класс Modal
Класс реализует общий функционал модальных окон веб приложения.\
